 ...
 */
@RestController
@RequestMapping("/system/questiontype")
public class QuestiontypeController extends BaseController
{
     ...
     * 查询【请填写功能名称】列表
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:list')")
    @GetMapping("/list")
     ...
     * 导出【请填写功能名称】列表
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:export')")
    @Log(title = "【请填写功能名称】", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Questiontype questiontype)
    {
        List<Questiontype> list = questiontypeService.selectQuestiontypeList(questiontype);
     ...
     * 获取【请填写功能名称】详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:query')")
    @GetMapping(value = "/{id}")
    public AjaxResult getInfo(@PathVariable("id") Long id)
    {
        return success(questiontypeService.selectQuestiontypeById(id));
    }

    /**
     * 新增【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:add')")
     ...
     * 修改【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:edit')")
    @Log(title = "【请填写功能名称】", businessType = BusinessType.UPDATE)
    @PutMapping
    public AjaxResult edit(@RequestBody Questiontype questiontype)
    {
     ...
     * 删除【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:questiontype:remove')")
