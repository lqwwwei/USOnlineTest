...
//    @PreAuthorize("@ss.hasPermi('system:score:add')")
    ...
    public AjaxResult getAnswerRecord(@RequestParam Long examId, @RequestParam Long userId) {

        ExamScore examScore = new ExamScore();
        examScore.setExamId(examId);
        examScore.setUserId(userId);
        List<ExamScore> records = examScoreService.selectExamScoreList(examScore);
